<template>
  <div id="landing2">
    <div class="section1">
      <img src="@/assets/img/finallogo_2.png" class="logo" alt="logo" />
      ...
      <div class="text-box">
        <p style="color: #4e4e4e;">
          온라인 수업에 적극적으로 참여할 수 있는 다양한 학습지원기능을 제공하여, 어디서든 교실과 차이 없는 온라인 수업이 가능한 교육환경을 제공합니다.
        </p>
      </div>
      <div class="buttons">
...
.button-guide {
  ...
  cursor: pointer;
  box-shadow: 0px 2px 0px #756bff;
}

.button-guide:hover {
  box-shadow: 0px 2px 5px #756bff;
  letter-spacing: 3px;
}
...
.button-start {
  ...
  font-family: 'Bai Jamjuree', sans-serif;
  cursor: pointer;
  box-shadow: 0px 2px 0px #ff625c;
  letter-spacing: 3px;
}

.button-start:hover {
  box-shadow: 0px 2px 5px #ff625c;
  letter-spacing: 3px;
}
</style>
